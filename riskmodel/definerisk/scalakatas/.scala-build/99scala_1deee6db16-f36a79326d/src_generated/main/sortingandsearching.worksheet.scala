...
final class sortingandsearching$u002Eworksheet$_ {
def args = sortingandsearching$u002Eworksheet_sc.args$
def scriptPath = """sortingandsearching.worksheet.sc"""
/*<script>*/
...
object sortingandsearching$u002Eworksheet_sc {
  ...
  lazy val script = new sortingandsearching$u002Eworksheet$_
...
export sortingandsearching$u002Eworksheet_sc.script as `sortingandsearching.worksheet`
